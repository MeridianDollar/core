  ...
  return (
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        ...
        <StaticRow
          ...
          infoIcon={
            <InfoIcon
              tooltip={
                <Card variant="tooltip" sx={{ width: "240px" }}>
                  The total amount of USM your Trove will hold.{" "}
                  {isDirty && (
                    <>
                      You will need to repay {totalDebt.sub(LUSD_LIQUIDATION_RESERVE).prettify(2)}{" "}
                      USM to reclaim your collateral ({LUSD_LIQUIDATION_RESERVE.toString()} USM
        ...
        {description ?? (
          <ActionDescription>
            Start by entering the amount of TLOS you'd like to deposit as collateral.
          </ActionDescription>
        )}
